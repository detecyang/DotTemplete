...
//  AisinoTaxesPlatform
//
//  Created by fu liku on 12-10-23.
//  Copyright 2012 aisino. All rights reserved.
//
...
- (id)initWithData:(NSData *)data options:(unsigned int)mask error:(NSError **)error {
	...
	if (self) {
		...
		const char *encoding = "utf8";//2013-03-06 yangqi 此处应赋值uft8，否则有时候xmlReadMemory函数解析出xml失败
